        ...
        <div>
            <div className="w-7/12 mx-auto mt-24 h-full  grid grid-rows-6 grid-cols-10 gap-4 bg-gray-200 rounded-md pb-8">
                <span className="col-start-5 col-span-2 row-span-1 text-center mt-2 text-[32px] font-bold">Contact us</span>
                    ...
                    <input onChange={handleEmailChange} placeholder="Enter your email address here.." type="text" size="45" className="py-3 px-2 rounded-md" />
                    </div>
                    ...
                    <div className="col-start-4 row-start-4 row-span-3">
                        <label>Message</label>
                        <textarea onChange={handleMessageChange} id="text-area" type="text" placeholder="Enter message here.." className="rounded-md px-2 py-3" />
                    </div>
                    </form>
