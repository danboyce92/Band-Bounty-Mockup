...
const Divider = ({ user }) => {
  ...
  return (
    <div id="divider-section">
      ...
      <div className=" w-full bg-gray-900 grid grid-rows-7 grid-cols-1 sm:grid-rows-7 sm:grid-cols-4 gap-4">
        <div className="h-full w-full top-0 left-0 col-span-1 row-span-4 col-start-1 row-start-1 sm:col-span-2 sm:row-span-6 sm:col-start-3 sm:row-start-1 bg-gray-900 opacity-40 z-5">
          <img
            src={LivePic2}
            alt="concert"
        ...
        <div className="col-span-1 col-start-1 row-start-5 sm:col-span-2 sm:row-span-6 sm:col-start-1 divide-y-2 divide-solid divide-gray-400 my-auto">
          ...
          <div className="col-span-2 col-start-1 row-start-3 row-span-2 text-white text-center mb-4">
            The artist has a window of 90 days to green-light the show
          </div>

          <div className="col-span-2 col-start-1 row-start-5 row-span-2 text-white text-center mb-4">
