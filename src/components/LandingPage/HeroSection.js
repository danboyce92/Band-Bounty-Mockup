        ...
        <div>
            <div className="h-screen  bg-[url('../gig.jpg')] bg-cover bg-no-repeat bg-bottom">
                <div className="h-full w-full bg-gray-900 top-0 left-0 opacity-90 z-1  grid grid-rows-6 grid-cols-6 gap-4">
                    <span className="relative col-span-3 col-start-2 row-start-2 flex text-xl justify-items-center line text-white leading-normal text-[64px]">Welcome to</span>
                    ...
                    <div className="h-full w-full top-0 left-0 col-span-2 row-span-2 col-start-4 row-start-4 text-white text-[42px] text-center">
                        <br/>
