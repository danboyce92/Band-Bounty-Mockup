                ...
                <div className="flex justify-between space-x-4 ml-5">
                    <div className="flex">
                        ...
                        <div className="flex items-center space-x-4 pl-8">
                            <Link to="livebounties" className="py-2 px-3 text-gray-700">Live Bounties</Link>
                            <Link to="/venues" className="py-2 px-3 text-gray-700">Venues</Link>
                        </div>
                    </div>

                    <div className="relative sign-in flex items-center right-5">
                        {(!user) ? 
                            <Link to="/signin" className="py-2 px-3 text-gray-700">Sign in</Link>                    
                        : 
                              <div className="flex items-center"> 
                                <div className="mr-6">{user.email}</div>
                                <div className="mr-3"><SignoutButton /></div> 
                              </div>
                        } 
                    </div>
                </div>
